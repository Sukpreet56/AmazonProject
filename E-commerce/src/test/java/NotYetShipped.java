...
public class NotYetShipped {
	...
	public static void main(String[] args) {
		...
		//step 9.Click on NotYetShipped Option
            driver.findElement(By.cssSelector("#a-page > section > div.your-orders-content-container__content.js-yo-main-content > div.a-section.a-spacing-medium.page-tabs > ul > li:nth-child(3) > a")).click();
	}
