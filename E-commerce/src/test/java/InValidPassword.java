...
public class InValidPassword {
	...
	public static void main(String[] args) {
		...
		//Step 5 Enter Password in "Password" field	less than 6 characters
				driver.findElement(By.id("ap_password")).sendKeys("Roop");
				
		//Step 6 Enter password in "Password again" field
				driver.findElement(By.id("ap_password_check")).sendKeys("Roop");
