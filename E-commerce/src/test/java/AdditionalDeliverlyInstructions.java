...
public class AdditionalDeliverlyInstructions {
	...
	public static void main(String[] args) {
		...
		//step 17: choose checkbox
			driver.findElement(By.id("address-ui-widgets-use-as-my-default")).click();
		//step 18: AddDelivery Instruction
		driver.findElement(By.cssSelector("#address-ui-widgets-enterAddressFormContainer > div.a-section.a-spacing-none.aok-inline-block > label > span")).click();
